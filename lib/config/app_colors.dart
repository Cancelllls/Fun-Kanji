...
abstract class AppColors {
  ...
  static const ColorScheme darkScheme = ColorScheme(
        ...
        primaryContainer: Color(0xFF3531C0),
        onPrimaryContainer: Color(0xFFE0E0FF),
        secondary: Color(0xFFC1C3FF),
        onSecondary: Color(0xFF2100B0),
        secondaryContainer: Color(0xFF3531C0),
        onSecondaryContainer: Color(0xFFE0E0FF),
        tertiary: Color(0xFF4ADE80),
        onTertiary: Color(0xFF003915),
        tertiaryContainer: Color(0xFF006B28),
        ...
        surfaceContainerHighest: Color(0xFF242433),
        onSurfaceVariant: Color(0xFFC8C5D8),
        outline: Color(0xFF9290A1),
        outlineVariant: Color(0xFF474660),
      );
}
